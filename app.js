...
function sumAndMultiply(a,b,c){ //eslint-disable-line
  var addMath = sum(a, b)[0];
  var addSum = sum(c, addMath)[0];
  var multiMath = multiply(a, b)[0];
  var multiSum = multiply(c, multiMath)[0];
  return [addSum, multiSum, + a + ' and ' + b + ' and ' + c + ' sum to ' + addSum + '.', 'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + multiSum + '.' ];
}
